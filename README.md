# IronFly. Praktikum Uni-Mainz. Nummer 1.


1. pip install pygame
2. pip install pygame ( terminal OS)
3. pip install ffpyplayer (for more information >= https://matham.github.io/ffpyplayer/installation.html )
4. pip install pymediainfo
5. Ready to run
